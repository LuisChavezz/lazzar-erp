...
// Tamaño de página del endpoint (fijo; máx. backend: 2000). Alimenta el cálculo
// de páginas totales (`count / PAGE_SIZE`) que consume el pager de `DataTable`.
const PAGE_SIZE = 100;
...
export default function ReportsPage() {
  ...
  const handleAlmacenChange = (id: number) => {
    setAlmacenId(id);
    setPage(1);
  };
