...
type QuoteStatusLike = Pick<Quote, "estatus"> | Quote["estatus"] | null | undefined;

const resolveStatus = (status: QuoteStatusLike) => { // Resuelve el estado del pedido
...
export const getStatusStyles = (status: QuoteStatusLike) => {
