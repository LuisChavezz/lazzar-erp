...
import { buildEmbroideryGroups } from "../utils/quoteProductEmbroideryGroups";

type QuoteDetail = QuoteById["detalles"][number];

interface QuoteProductEmbroideryViewProps {
  detail: QuoteDetail;
  onBack: () => void;
}
const externalImageLoader = ({ src }: { src: string }) => src;

export const QuoteProductEmbroideryView = ({ detail, onBack }: QuoteProductEmbroideryViewProps) => {
