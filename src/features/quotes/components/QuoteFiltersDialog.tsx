...
import { quoteFiltersDefault, QuoteFiltersValue } from "../stores/quote-filters.store";

interface QuoteFiltersDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  value: QuoteFiltersValue;
  onApply: (value: QuoteFiltersValue) => void;
  onSave: (value: QuoteFiltersValue) => void;
  onClearSaved: () => void;
  savedValue: QuoteFiltersValue;
  personaPagosOptions: { value: string; label: string }[];
}

export const QuoteFiltersDialog = ({
  open,
  onOpenChange,
  value,
  onApply,
  ...
  savedValue,
  personaPagosOptions,
}: QuoteFiltersDialogProps) => {
  const [localValue, setLocalValue] = useState<QuoteFiltersValue>(value);
  ...
  const isFiltersEqual = (first: QuoteFiltersValue, second: QuoteFiltersValue) => {
  ...
  const isSavedValueEmpty = isFiltersEqual(savedValue, quoteFiltersDefault);
