...
export const KANBAN_COLUMNS: KanbanColumnConfig[] = [
  ...
  },
  {
    ...
    accentBorderLeft: "border-l-violet-400",
    accentDot: "bg-violet-400",
    badgeClass: "bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-300",
    cardShadowHover: "hover:shadow-violet-500/25 dark:hover:shadow-violet-500/25",
    dropActiveClass: "ring-2 ring-violet-400/50 bg-violet-50/40 dark:bg-violet-500/5",
  },
];
