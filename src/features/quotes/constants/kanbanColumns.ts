...
export const KANBAN_COLUMNS: KanbanColumnConfig[] = [
  {
    ...
    accentBorderLeft: "border-l-sky-400",
    accentDot: "bg-sky-400",
    badgeClass: "bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300",
    cardShadowHover: "hover:shadow-sky-500/25 dark:hover:shadow-sky-500/25",
    dropActiveClass: "ring-2 ring-sky-400/50 bg-sky-50/40 dark:bg-sky-500/5",
  },
  {
    id: "col-2",
    estatus: 2,
