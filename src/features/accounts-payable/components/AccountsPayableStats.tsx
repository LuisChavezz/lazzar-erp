  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="p-8 rounded-4xl bg-white dark:bg-black border border-slate-100 dark:border-white/20 shadow-xl shadow-slate-200/50 dark:shadow-black/50">
        ...
        <h3 className="text-2xl font-bold mt-1 text-slate-800 dark:text-white">$325,890</h3>
      </div>
      ...
      <div className="p-8 rounded-4xl bg-white dark:bg-black border border-slate-100 dark:border-white/20 shadow-xl shadow-slate-200/50 dark:shadow-black/50">
        ...
        <h3 className="text-2xl font-bold mt-1 text-slate-800 dark:text-white">$120,450</h3>
      </div>
      ...
      <div className="p-8 rounded-4xl bg-white dark:bg-black border border-slate-100 dark:border-white/20 shadow-xl shadow-slate-200/50 dark:shadow-black/50">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Pagado del Mes</p>
        <h3 className="text-2xl font-bold mt-1 text-slate-800 dark:text-white">$210,300</h3>
      </div>
      ...
      <div className="p-8 rounded-4xl bg-white dark:bg-black border border-slate-100 dark:border-white/20 shadow-xl shadow-slate-200/50 dark:shadow-black/50">
        ...
        <h3 className="text-2xl font-bold mt-1 text-slate-800 dark:text-white">$32,780</h3>
      </div>
    </div>
  );
};
