...
import { EmbroideryOrderItem } from "../interfaces/embroidery-quote.interface";
import { EditIcon, ViewIcon } from "../../../components/Icons";
import { ActionMenu, ActionMenuItem } from "@/src/components/ActionMenu";

const EmbroideryStatusBadge = ({
  status,
}: {
  status: EmbroideryOrderItem["estatus"];
}) => {
  const styles: Record<EmbroideryOrderItem["estatus"], string> = {
...
export const embroideryQuoteColumns: ColumnDef<EmbroideryOrderItem>[] = [
  {
    accessorKey: "pedido",
    header: "Pedido",
    cell: ({ row }) => (
  ...
  },
  {
    accessorKey: "estatus",
    header: "Estatus",
    cell: ({ row }) => <EmbroideryStatusBadge status={row.getValue("estatus")} />,
  },
  {
    accessorKey: "piezas",
    header: "Piezas",
