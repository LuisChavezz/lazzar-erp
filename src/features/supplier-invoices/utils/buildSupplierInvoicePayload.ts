 ...
 *
 * Solo `folio`, `fecha_vencimiento`, `observaciones` y `estatus`. NUNCA
 * renglones (el PATCH los ignoraría: escritura solo en el alta) ni importes (se
 * derivan de los renglones, que ya no cambian).
 */
