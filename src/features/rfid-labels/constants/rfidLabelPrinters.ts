import type { RfidLabelPrinter } from "../interfaces/rfid-label.interface";
 ...
 * `mocks/rfid-labels.mock.ts`. Nada detrás detecta ni valida estos equipos.
 */
export const MOCK_RFID_LABEL_PRINTERS: RfidLabelPrinter[] = [
