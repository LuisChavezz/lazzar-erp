...
interface BomStep3Props {
  /** Variant selected in Step 1. */
  productoVarianteId: number;
  /** Product ids selected in Step 2 — one config card each. */
  componentIds: number[];
  /** Returns to Step 2. */
  onBack: () => void;
 ...
 * BomStep3
 *
 * Step 3 of the BOM onboarding flow. Renders one configuration card per product
 * selected in Step 2 (stacked, scrollable) with the five per-item fields:
