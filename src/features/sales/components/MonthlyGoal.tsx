      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Abril 2026</p>
          </div>
        ...
        <div className="mb-4">
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold font-mono text-slate-800 dark:text-white">$0.00</span>
        ...
        <div className="w-full bg-slate-100 dark:bg-white/10 rounded-full h-1.5 mb-2">
          <div className="bg-linear-to-r from-sky-500 to-blue-500 h-1.5 rounded-full w-[1%]" />
        </div>
