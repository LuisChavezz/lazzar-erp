/**
 * Schema para un item de la solicitud (producto):
 ...
 *
 * CLON de `quotes/schemas/quote-item.schema.ts`.
 */
import { z } from "zod";
...
import { requestItemSizeSchema } from "./request-item-size.schema";
...
export const requestItemSchema = z
  .object({
    ...
    availableSizes: z
      ...
      .optional(),
    tallas: z.array(requestItemSizeSchema).optional(),
