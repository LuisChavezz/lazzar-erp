...
export type OrderDetailSize = OrderDetail["tallas"][number];
...
const getEmbroideryKey = (size: OrderDetailSize) => {
...
export const buildEmbroideryGroups = (sizes: OrderDetailSize[]): EmbroideryGroup[] => { // Build embroidery groups
