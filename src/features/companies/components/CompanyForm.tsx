        ...
        <section className="relative overflow-hidden bg-white dark:bg-zinc-900 rounded-3xl p-6 md:p-8 border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none group hover:border-sky-200 dark:hover:border-sky-900 transition-colors duration-300">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start relative z-10">
            ...
            <div className="shrink-0 relative group/logo">
              <div className="w-32 h-32 rounded-2xl bg-slate-50 dark:bg-black/20 border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col items-center justify-center text-slate-400 transition-all hover:border-sky-500 hover:text-sky-500 hover:bg-sky-50/50 dark:hover:bg-sky-900/10 cursor-pointer overflow-hidden shadow-inner relative">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  placeholder="URL del Logo"
                  className="w-32 text-xs bg-transparent border-b border-slate-200 dark:border-slate-700 focus:border-sky-500 outline-none text-slate-600 dark:text-slate-400"
                  {...register("logo_url")}
                />
              </div>
            </div>
