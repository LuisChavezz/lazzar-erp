...
export const QuoteEmail = ({ quote }: QuoteEmailProps) => {
  ...
  return (
    <BaseEmailLayout
      previewText={`Cotizacion #${quote.id} para ${customerName}`}
      headingText={<>Cotizacion #{quote.id}</>}
      descriptionText="Se genero una cotizacion lista para revision con el detalle comercial del pedido."
      footerText="Este correo fue generado automaticamente desde el modulo de cotizaciones para validar el diseno del template."
    >
          ...
          <EmailCard title="Productos cotizados">
          ...
          <EmailCard title="Totales y seguimiento">
            <table className="mt-4 w-full border-collapse text-sm">
              <tbody>
                <tr>
          ...
          <EmailCard title="Datos de contacto y envio">
            <table className="mt-4 w-full border-collapse text-sm">
              <tbody>
                <tr>
